            ...
            <div class="row mt-5">
                <div class="col-md-6 mb-4">
                    <div class="pix-qrcode">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=00020126400014br.gov.bcb.pix0126araujo.renato045%40gmail.com5204000053039865802BR5913RENATO+ARAUJO609SAO+PAULO62070503%2A%2A%2A6304XXXX" alt="QR Code PIX" id="qrCodePix">
                ...
                <div class="col-md-6 text-start">
                    ...
                    <div class="mt-4 p-3 bg-white bg-opacity-25 rounded">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars(PIX_KEY); ?>" id="chavePix" readonly>
